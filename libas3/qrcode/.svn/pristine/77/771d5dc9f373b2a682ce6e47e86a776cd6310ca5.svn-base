...
package com.logosware.utils.QRcode 
{
	...
	public class QRCodeDetecter extends Sprite
	{
		...
		private var ORIGIN_POINT:Point = new Point();
...
*/
		...
		public function detect():Array {
			...
			// グレー化
			// this idea is based on Saqoosha's article. http://blog.jactionscripters.com/2009/05/18/adaptive-thresholding-experiment/#more-351
			bd2.applyFilter(bd, IMAGE_RECT, ORIGIN_POINT, new BlurFilter(64, 64));
			bd2.draw( image, null, null, BlendMode.SUBTRACT );
			
			// 二値化
			bd.fillRect(IMAGE_RECT, 0xFFFFFFFF);
			bd.threshold(bd2, IMAGE_RECT, ORIGIN_POINT, ">", 0x00001000, 0xFF000000, 0x0000FF00);
