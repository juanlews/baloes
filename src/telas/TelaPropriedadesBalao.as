package telas
{
	...
	public class TelaPropriedadesBalao extends Tela
	{
		...
		override public function desenho(evento:Event = null):void
		{
			...
			this._cor2.x = this._cor1.x + stage.stageWidth/5;
			this._cor2.y = this._excluir.y + this._excluir.height + this._cor2.height/4 ; 	
			this._cor2.width = stage.stageWidth /8;
			this._cor2.scaleY = this._cor2.scaleX;
			this.addChild(this._cor2);
			
			this._cor3.x = this._cor2.x + stage.stageWidth /5;
			this._cor3.y = this._excluir.y + this._excluir.height + this._cor3.height/4 ;
			this._cor3.width = stage.stageWidth / 8;
			this._cor3.scaleY = this._cor3.scaleX;
			this.addChild(this._cor3);
			
			this._cor4.x = this._cor3.x + stage.stageWidth /5;
			this._cor4.y = this._excluir.y + this._excluir.height + this._cor4.height/4 ;
